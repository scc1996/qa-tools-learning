...
（7）TCP协议主要通过以下七点来保证传输可靠性：连接管理，校验和，序列号，确认应答，超时重传，流量控制，拥塞控制。 连接管理即三次握手和四次挥手。 连接管理机制能够建立起可靠的连接，这是保证传输可靠性的前提。
https://blog.csdn.net/zs18753479279/article/details/115588009
