...
33. 最大堆和最小堆
完全二叉树：只有最后一层不满且叶子节点集中于左边
满二叉树：一颗深度为k的树，有2k-1个节点 -- 所有节点都是满挂

堆的实质其实就是一颗完全二叉树最大堆特点：父节点值均大于子节点；(堆顶元素最大)最小堆特点：父节点值均小于子节点；(堆顶元素最小)
最大堆和最小堆，可以定义具体的数据结构
例如：最大堆，堆顶的数据是最大的，所有的值都比堆顶小，所以找最小k个值，可以
